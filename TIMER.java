...
public class TIMER {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        tryAgainBtn.setIcon(new ImageIcon("com/BIT5/AnatomyDetective/assets/try_again_button.png"));
        ...
        menuBtn = new JButton();
        menuBtn.setIcon(new ImageIcon("com/BIT5/AnatomyDetective/assets/menu_button.png"));
